...
SET(_POSSIBLE_LUA_INCLUDE include include/lua include/luajit-2.0)
SET(_POSSIBLE_LUA_EXECUTABLE lua luajit luajit2)
...
IF( (NOT DEFINED CMAKE_VERSION) OR (${CMAKE_VERSION} VERSION_LESS "2.8.3") )
	FIND_PACKAGE_HANDLE_STANDARD_ARGS(Lua LUA_LIBRARIES LUA_INCLUDE_DIR)
	SET(LUA_VERSION_STRING "LUA_VERSION_STRING-NOTFOUND")
ELSE( (NOT DEFINED CMAKE_VERSION) OR (${CMAKE_VERSION} VERSION_LESS "2.8.3") ) 
	FIND_PACKAGE_HANDLE_STANDARD_ARGS(Lua
                                  REQUIRED_VARS LUA_LIBRARIES LUA_INCLUDE_DIR
                                  VERSION_VAR LUA_VERSION_STRING)
ENDIF( (NOT DEFINED CMAKE_VERSION) OR (${CMAKE_VERSION} VERSION_LESS "2.8.3") )
